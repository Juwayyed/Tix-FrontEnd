...
<template>
  <div class="p-6">
          ...
          <div>
            ...
            <div class="mt-4 flex items-center space-x-4">
              ...
              <span class="text-sm text-gray-500"
                >Reported by {{ ticket.user?.name }}</span
              >
            </div>
          </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100">
      ...
      <div v-else>
        <div class="p-6">
          <p class="text-sm text-gray-500">No Response Yet</p>
        </div>
      </div>

      <div class="p-6 border-t border-gray-100">
        <h4 class="text-sm font-medium text-gray-800 mb-4">Add Reply</h4>
        <form @submit.prevent="handleSubmit" class="space-y-4">
          <div class="grid grid-cols-1 gap-4">
            <div>
              ...
              >
                ...
                <option value="in_progress" class="text-yellow-700">
                  In Progress
                </option>
          ...
          <div class="flex items-center justify-between">
            ...
            >
              ...
              <span v-if="!loading">Send Reply</span>
